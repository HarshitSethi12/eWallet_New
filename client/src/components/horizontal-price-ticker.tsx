    ...
    queryFn: async () => {
      try {
        ...
        const cryptoList = [
          ...
          { symbol: 'AVAX', name: 'Avalanche', price: data['avalanche-2']?.usd || 0, change: data['avalanche-2']?.usd_24h_change || 0 },
          { symbol: 'SHIB', name: 'Shiba Inu', price: data['shiba-inu']?.usd || 0, change: data['shiba-inu']?.usd_24h_change || 0 },
          ...
          { symbol: 'BCH', name: 'Bitcoin Cash', price: data['bitcoin-cash']?.usd || 0, change: data['bitcoin-cash']?.usd_24h_change || 0 },
          { symbol: 'MATIC', name: 'Polygon', price: data.polygon?.usd || 0, change: data.polygon?.usd_24h_change || 0 },
          { symbol: 'LTC', name: 'Litecoin', price: data.litecoin?.usd || 0, change: data.litecoin?.usd_24h_change || 0 },
          { symbol: 'NEAR', name: 'Near Protocol', price: data.near?.usd || 0, change: data.near?.usd_24h_change || 0 },
          { symbol: 'UNI', name: 'Uniswap', price: data.uniswap?.usd || 0, change: data.uniswap?.usd_24h_change || 0 },
          { symbol: 'ICP', name: 'Internet Computer', price: data['internet-computer']?.usd || 0, change: data['internet-computer']?.usd_24h_change || 0 },
          { symbol: 'ETC', name: 'Ethereum Classic', price: data['ethereum-classic']?.usd || 0, change: data['ethereum-classic']?.usd_24h_change || 0 },
          { symbol: 'XLM', name: 'Stellar', price: data.stellar?.usd || 0, change: data.stellar?.usd_24h_change || 0 },
          { symbol: 'FIL', name: 'Filecoin', price: data.filecoin?.usd || 0, change: data.filecoin?.usd_24h_change || 0 },
          { symbol: 'ATOM', name: 'Cosmos', price: data.cosmos?.usd || 0, change: data.cosmos?.usd_24h_change || 0 },
          { symbol: 'XMR', name: 'Monero', price: data.monero?.usd || 0, change: data.monero?.usd_24h_change || 0 },
