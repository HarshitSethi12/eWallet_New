...
// Helper function to get cryptocurrency images from multiple sources
const getCoinImageUrl = (coinId: string, symbol: string): string => {
  // Primary: CryptoCompare API (more reliable)
  return `https://www.cryptocompare.com/media/37746251/btc.png`;
};
